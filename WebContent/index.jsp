			...
			<div id="page-wrapper">
				...
				<!-- Header -->
					<header id="header" class="alt">
						...
						<nav id="nav">
							<ul>
								<li>
									<a href="#menu" class="menuToggle"><span>Hotspots</span></a>
									<div id="menu">
										<ul>
											<li><a href="index.html">Mais acessdos</a></li>
											<li><a href="generic.html">Conteúdos Publicados </a></li>
				...
				<!-- One -->
					<section id="one" class="wrapper style1 special">
						<div class="inner">
							<header class="major">
								<h2>Compartilhe seu conhecimento mesmo sem ser um colaborador</h2>
